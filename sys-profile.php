...
if(isset($_SESSION['admin'])){
	echo "<script> location.replace('admin-profile.php'); </script>";
	exit();
}
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/system-profile.css">
...
<body>
	...
	<nav class="navigation">
			...
			<ul class="tabs"> 
				...
				<a href="sys-profile.php"><li id='active'><i class="fa fa-user"></i>PROFILE</li></a>
				...
				<a href="sys-profile.php?logout=1"><li><i class="fas fa-sign-out-alt"></i>LOG OUT</li></a>
			</ul>
		</nav>
...
$("[type=file]").on("change", function(){
  ...
  }); --> <!-- JAVA SCRIPT FOR BUTTON OF PROF PIC-->