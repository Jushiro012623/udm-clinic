            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo "<tr>
                        ...
                        <td style='background-color:#FF4040;color:white;'><a style='text-decoration:none;color:white;'href = 'sys-stdconsultation.php?deleteconsultation=1&student_no=".$row['student_no']."&illness_code=".$row['illness_code']."&date_consulted=".$row['date_consulted']."' onclick=";?>"return confirm('Are you sure you want to delete?')"<?php echo ">Delete</a></td>
                    </tr>";
                    }
                    ?>     
                        </table>
