			...
			<div class="table">
						...
						else
						{
							while($row = mysqli_fetch_assoc($result)){
								...
								echo    "<tr>";
								echo		"<td>".$row['illness_code']."</td>";
								echo		"<td style='text-align:left; padding-left:2em; display:flex; flex-wrap:wrap;'>".$row['illness_desc']."</td>";
								echo		"<td style='width:7%;'><a style='color:#000' href = 'admin-illness.php?adelete=1&illness_code=".$row['illness_code']."' onclick=";?>"return confirm('Are you sure you want to delete?')"<?php echo ">Delete</a></td>";						
								echo		"</tr>";
