                ...
                <div class="modal-body">
                    ...
                    <?php
                            ...
                            echo "<tr>
                                ...
                                <td>".$row['SY']."</td>
                                <td>".$row['semester']."</td>
                                <td style='background-color:#FF4040;color:white;'><a style='text-decoration:none;color:white;' href = 'sys-medicalreq.php?deletemedical=1&student_no=".$row['student_no']."&illness_code=".$row['illness_code']."&school_year=".$row['SY']."&semester=".$row['semester']."&datetime_medical=".$row['datetime_medical']."' onclick=";?>"return confirm('Are you sure you want to delete?')"<?php echo ">Delete</a></td>
                            </tr>";
                            }
                    ?>     
                        </table>
