            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    echo "<tr>
                        ...
                        <td>".$row['illness_desc']."</td>
                        <td>".$row['diagnosis']."</td>
                        <td>".$row['attending_physician']."</td>
                        <td>".$row['date_consulted']."</td>
                        <td style='background-color:#FF0000;color:white;'><a href = 'sys-stdconsultation.php?deleteconsultation=1&student_no=".$row['student_no']."&illness_code=".$row['illness_code']."&date_consulted=".$row['date_consulted']."' onclick=";?>"return confirm('Are you sure you want to delete?')"<?php echo ">Delete</a></td>
                    </tr>";
                    }
                    ?>     
                        </table>
