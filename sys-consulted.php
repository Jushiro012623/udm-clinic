...
if(isset($_SESSION['admin'])){
	echo "<script> location.replace('admin-consulted.php'); </script>";
	exit();
}
			...
			<ul class="tabs"> 
				...
				<div class="dropdown">
                    ...
                    <ul>
                        ...
                        <a href="sys-consulted.php"><li id='active'><i class="fas fa-file-medical"></i>CONSULTED</li></a><br>
			...
			<div class="table">
						...
						if(isset($_GET['search']))
						{
							...
							while($row = mysqli_fetch_assoc($result)){
								...
								echo		"<td style='background-color:#25bfcd;'><a style='color:#fff' href='sys-stdconsultation.php?student_no=".$row['student_no']."'>View</a></td>";					
								echo		"</tr>";
								...
								{
									echo "<div id='page'><a href='sys-consulted.php?search=".$search."&submit=Submit&page=".$i."'>$i</a></div>";
								}
						...
						else
						{
							while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo		"<td>".$row['stud_gender']."</td>";
                                echo		"<td>".$row['course_code']."</td>";
								echo		"<td style='width:7%;''><a style='color:#000'href='sys-stdconsultation.php?student_no=".$row['student_no']."'>View</a></td>";					
								echo		"</tr>";
						...
						for($i=1;$i<$total_page+1;$i++)
						{
							echo "<div id='page'><a href='sys-consulted.php?page=".$i."'>$i</a></div>";
						}
						echo "</div>";?>?>
