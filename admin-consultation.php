			...
			<div class="table" style = "display:table;">
						...
						else
						{
							while($row = mysqli_fetch_assoc($result)){
								...
								echo		"<td style='width:7%;'><a style='color:#000' href='admin-consultationview.php?student_no=".$row['student_no']."&illness_code=".$row['illness_code']."&date_prepared=".$row['date_prepared']."'>Consult</a></td>";
								echo		"<td style='background-color:#ff4040; width:7%;'><a style='color:white' href = 'admin-consultation.php?admin-delete=1&student_no=".$row['student_no']."&illness_code=".$row['illness_code']."&date_prepared=".$row['date_prepared']."' onclick=";?>"return confirm('Are you sure you want to delete?')"<?php echo ">Delete</a></td>";						
								echo		"</tr>";
