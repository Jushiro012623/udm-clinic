...
if(isset($_POST['consultsys']))
{
    ...
    if (mysqli_query($conn, $sql)){
		...
		if(mysqli_query($conn, $sql)){
			echo '<script>alert("Successfully consulted a record");window.location.href = "sys-consultation.php?consultrecord=1";</script>';
		}else{
			echo '<script>alert("Consult record failed");window.location.href = "sys-consultation.php?consult=fail";</script>';
		}
	}else{
		echo '<script>alert("Error Consulting a record");window.location.href = "sys-consultation.php?consultfail=1";</script>';
	}
						...
						<div class="information-inputed" id="modal-fielset-div">
							...
							<fieldset class="consultation-info" id="modal-fieldset">
								...
								<div class="modal-footer">
										<button  onclick="window.location.href='/clinicupdate/sys-consultation.php'" value = "back" name="back" class="buttonmodal" id="backbttn">Back</button>
										<button  type="submit" value="consult" name="consultsys" class="buttonmodal" id="consultbtn">Consult</button>
									</div>
							</fieldset>
						</form>
						</div>
